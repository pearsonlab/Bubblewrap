...
class Mesh:
    ...
    def rotate(self, scaling="global"):
        if scaling == "global":
            ...
            self.vectors = (self.alpha * self.vectors + self.beta * self.obs.vect) / (
            ...
            self.vectors = (
                self.alpha * (self.dist) @ self.vectors + self.beta * (self.dist) @ self.obs.vect
            ) / norm
