...
# breakpoint()
T = data.shape[0]       # should be 89900
...
if make_movie:
    ...
    writer.setup(fig, 'bubblewrap_2d_mouse.mp4')
...
# np.save('mouse_3d_A', gq.A)
# np.save('mouse_3d_L', gq.L)
# np.save('mouse_3d_n_obs', gq.n_obs)
# np.save('mouse_3d_mu', gq.mu)
# np.save('mouse_3d_pred', gq.pred)
# np.save('mouse_3d_entropy', np.array(gq.entropy_list))
